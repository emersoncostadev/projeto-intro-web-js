...
/* console.log(realizarMatricula)
console.log(nomeInput)
console.log(turmaInput)
console.log(cursoInput)
console.log(numParcelasInput) */
...
if(realizarMatricula){
  ...
  alunomatriculado.innerHTML=`<div ><h2>Aluno Matriculado <img src="./Midia/correto.jpg" alt=""></h2> </div>`
...
/* `<div ><h2>Aluno Matriculado <img src="./Midia/—Pngtree—correct icon transparent_8642843.png" alt=""></h2> </div>` */